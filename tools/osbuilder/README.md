...
Ubuntu is the default distro for building the rootfs, to use a different one, you can set `DISTRO=alpine|clearlinux|debian|ubuntu|mariner`.
...
|           |Alpine            |CentOS Stream     |Clear Linux       |Debian/Ubuntu     |Mariner           |
|--         |--                |--                |--                |--                |--                |
