...
type ApiVmAddIgvmPutRequest struct {
	ctx        _context.Context
	ApiService *DefaultApiService
	igvmConfig *IgvmConfig
}

// The details of the new igvm device
func (r ApiVmAddIgvmPutRequest) IgvmConfig(igvmConfig IgvmConfig) ApiVmAddIgvmPutRequest {
	r.igvmConfig = &igvmConfig
	return r
}

func (r ApiVmAddIgvmPutRequest) Execute() (PciDeviceInfo, *_nethttp.Response, error) {
	return r.ApiService.VmAddIgvmPutExecute(r)
}

/*
VmAddIgvmPut Add a new igvm device to the VM

	@param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiVmAddIgvmPutRequest
*/
func (a *DefaultApiService) VmAddIgvmPut(ctx _context.Context) ApiVmAddIgvmPutRequest {
	return ApiVmAddIgvmPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return PciDeviceInfo
func (a *DefaultApiService) VmAddIgvmPutExecute(r ApiVmAddIgvmPutRequest) (PciDeviceInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.VmAddIgvmPut")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/vm.add-igvm"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.igvmConfig == nil {
		return localVarReturnValue, nil, reportError("igvmConfig is required and must be specified")
	}
